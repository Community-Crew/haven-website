...
import { Organisation, Paginator, Reservation, Room, Unit } from '@/types';
...
const isEditable = (reservation: Reservation) => {
    ...
    return (
        start > now &&
        reservation.status.label !== 'Canceled' &&
        reservation.status.label !== 'Rejected'
    );
};
            ...
            <div class="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-8">
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                ...
                                @click="prevSlide"
                                class="absolute top-1/2 left-[-10px] z-20 -translate-y-1/2 rounded-full p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-haven-blue focus:outline-none md:left-0"
                            >
                                <svg
                            ...
                            <div class="w-full flex-grow px-6">
                                <Transition name="fade" mode="out-in">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex min-h-[5.5rem] flex-col justify-end pb-1 text-haven-black"
                                        >
                                            <h2
                                        ...
                                        <hr
                                            class="my-6 border-t border-haven-blue/20"
                                        />
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="text-brand-dark-blue/80"
                                                    >{{
                                                        currentItem.data.unit.padStart(
                                                            2,
                                                            '0',
                                                        )
                                                    }}</span
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex min-h-[5.5rem] items-end justify-between gap-4 pb-1 text-haven-black"
                                        >
                                            <!-- Name (Left) -->
                                            <h2
                                                class="mb-0.5 place-self-center text-2xl leading-tight font-bold"
                                            >
                                                {{ currentItem.data.name }}
                                            </h2>
                                        ...
                                        <hr
                                            class="mb-4 border-t border-haven-blue/20"
                                        />

                                        <div class="space-y-4">
                                            <p
                                                class="text-brand-dark-blue/80 whitespace-pre-line"
                                            >
                                                {{
                                                    currentItem.data.about ||
                            ...
                            <button
                                v-if="carouselItems.length > 1"
                                @click="nextSlide"
                                class="absolute top-1/2 right-[-10px] z-20 -translate-y-1/2 rounded-full p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-haven-blue focus:outline-none md:right-0"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                            ...
                            <div
                                v-if="carouselItems.length > 1"
                                class="mt-auto flex justify-center gap-2 pt-6"
                            >
                                <button
                ...
                >
                    <div
                        ...
                        class="mt-4 grid gap-x-8 gap-y-4 md:grid-cols-2"
                    >
                        <div
                        ...
                        >
                            <div class="mb-2 flex items-start justify-between">
                                <div class="overflow-hidden">
                                    <p
                                        class="truncate font-bold text-haven-black"
                                ...
                                >
                                    ...
                                    />
                                    <div class="lg:inline text-haven-black hidden">
                                ...
                                <div class="flex flex-col items-end gap-2">
                                    <span
                                        ...
                                        "
                                        class="rounded-lg px-2 py-1 text-xs font-bold tracking-wide uppercase"
                                    >
                            ...
                            <div class="flex items-end justify-between">
                                ...
                                <button
                                    ...
                                    class="group flex items-center gap-1 rounded-lg bg-white px-3 py-1.5 text-xs font-bold text-haven-blue shadow-sm ring-1 ring-gray-300 transition-colors ring-inset hover:bg-gray-50"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                                        class="h-4 w-4 text-gray-400 group-hover:text-haven-blue"
                                    >
                                        <path
